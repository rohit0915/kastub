...
function UnreadMessages(props) {
    ...
    const [allMessagedata, setallMessagedata] = useState([
        { id: 1, subject: "Tena Thomas", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
        { id: 2, subject: "loni", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
        ...
        { id: 4, subject: "Sanki", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
...
export default withRouter(UnreadMessages)
