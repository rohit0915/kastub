...
function AllMessages(props) {
    ...
    const [allMessagedata, setallMessagedata] = useState([
        { id: 1, subject: "Lorem ipsum", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
        { id: 2, subject: "Ujjawal", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
        { id: 3, subject: "Jhon Doe", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
        { id: 4, subject: "Briz Shepered", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
