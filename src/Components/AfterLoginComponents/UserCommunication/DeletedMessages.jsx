...
function DeletedMessages(props) {
    const classes = useStyles();
    const [messagedetail, setmessagedetail] = useState(false)
    const [allMessagedata, setallMessagedata] = useState([
        { id: 1, subject: "Lorem ipsum", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "delete" },
        { id: 2, subject: "Ujjawal", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "delete" },
    ]);
...
export default withRouter(DeletedMessages)
