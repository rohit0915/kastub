...
function ImportantMessage(props) {
    ...
    const [allMessagedata, setallMessagedata] = useState([
        ...
        { id: 2, subject: "tio Dhas", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
        ...
        { id: 4, subject: "James", content: "Lorem ipsum is a placeholder text commonly used", date: "09/10/2021", ischecked: false, status: "active" },
...
export default withRouter(ImportantMessage)
